...
class TestHello(BaseCase):
    ...
    def test_call_wo_name(self):
        ...
        Asserts.assert_json_has_key(response, "result")
        Asserts.assert_json_value_by_key(response, "result", "Hello, someone")
    ...
    def test_call_with_name(self):
        ...
        Asserts.assert_code_status(response, 200)
        Asserts.assert_json_has_key(response, "result")
        Asserts.assert_json_value_by_key(response, "result", f"Hello, {name}")
